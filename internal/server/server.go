...
func Run(spOverride *config.ServerParameters) error {
	...
	if spOverride == nil {
		...
		flag.StringVar(&sp.PrivateRsaPath, config.SpKeyPrivateRsa, config.SpDefaultPrivateRsa, "path to RSA key")
		flag.StringVar(&sp.PrivateEcdsaPath, config.SpKeyPrivateEcdsa, config.SpDefaultPrivateEcdsa, "path to ECDSA key")
		flag.StringVar(&sp.PrivateEd25519Path, config.SpKeyPrivateEd25519, config.SpDefaultPrivateEd25519, "path to Ed25519 key")
		flag.StringVar(&sp.AuthorizedKeysPath, config.SpKeyAuthorizedKeys, config.SpDefaultAuthorizedKeys, "path to authorized_keys")
